...
var MUNSTALK = window.MUNSTALK || {};

(function(window, document, $, MUNSTALK) {
    "use strict";
    MUNSTALK.validationUtil = (function() {
...
}(window, document, jQuery, MUNSTALK));

/* Bind the validation utilities function to document load */
jQuery(MUNSTALK.validationUtil.initFunction);